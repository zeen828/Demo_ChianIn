            <footer class="mt-5 py-5 footer-chianin border-top d-none d-md-block">
@section('footer')
                <div class="container">
                    <div class="row text-center text-md-start">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="#" class="text-decoration-none text-muted">隱私權政策</a></li>
                            </ul>
                        </div>
                        <!-- 聯絡方式 -->
                        <div class="col-md-4 mb-4">
                            ...
                            <p class="text-muted small">
                                ...
                                <i class="bi bi-geo-alt"></i> 台灣，新北市
                            </p>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="text-center text-muted small">
                        &copy; 2026 ChianIn. All rights reserved.
                    </div>
                </div>
@show
            </footer>
